...
//go:embed resources/pertamina.png
var uploadFileTest []byte

func TestUploadFile(t *testing.T) {
	body := new(bytes.Buffer)

	writer, _ := generateBody(body)
...
func generateBody(body *bytes.Buffer) (*multipart.Writer, error) {
	writer := multipart.NewWriter(body)
	writer.WriteField("name", "Eko Kurniawan Khannedy")
	file, err := writer.CreateFormFile("file", "upload-test-pertamina.png")
